  ...
  >
    ...
    <TransitionExpand>
      <ul v-show="isGroupOpen" class="nav-group-children">
        <Component
          :is="'children' in child ? 'VerticalNavGroup' : MenuItemLink"
...
import { isNavGroupActive, openGroups } from './utils'
import { useRoute, useRouter } from 'vue-router'
import { useWindowSize } from '@vueuse/core'
import { inject, ref, watch } from 'vue'
import TransitionExpand from "@/layouts/NavBarUtils/TransitionExpand.vue";
