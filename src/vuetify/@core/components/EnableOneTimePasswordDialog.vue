  ...
  >
    ...
    <VCard class="pa-5 pa-sm-15">
      <VCardItem class="text-center">
        <VCardTitle class="text-h5 font-weight-medium"> Enable One Time Password </VCardTitle>
        <VCardSubtitle class="mt-3"> Verify Your Mobile Number for SMS </VCardSubtitle>
      </VCardItem>
      ...
      <VCardText class="pt-6">
        ...
        <VForm @submit.prevent="() => {}">
          ...
          <VBtn type="submit" class="me-3" @click="formSubmit"> Submit </VBtn>
