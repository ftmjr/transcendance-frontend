<template>
  <button :disabled="notification.status === 'READ'" class="relative block w-full p-4 hover:bg-[#01051e] cursor-pointer"
    @click="handleRead">
    <div class="flex gap-4 w-full relative">
      ...
      <div class="flex-1 flex-col pr-4">
        ...
        <div class="flex gap-2 mt-4">
          <button
            class="px-8 py-2 rounded-md border border-gray-50/10 text-xs bg-green-700/50 hover:bg-green-700/60 text-gary-500">Jouer</button>
          <button
            class="px-4 py-2 rounded-md border border-gray-50/10 text-xs bg-red-700/50 hover:bg-red-700/60 text-gary-500">Refuser</button>
        </div>
      </div>
