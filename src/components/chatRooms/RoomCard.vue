<template>
  <div
    class="p-2 my-2 bg-slate-600/50 rounded hover:bg-slate-800/50 hover:scale-95 transition ease-in-out delay-150"
  >
    <p class="flex gap-2 items-center">
      ...
      <span class="text-disabled"> • {{ room.members.length }} membres </span>
    </p>
  </div>
</template>
