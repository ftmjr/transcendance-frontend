  ...
  <div class="window">
    <v-container fluid>
      ...
      <v-card class="mx-auto" max-width="500">
        ...
        <v-virtual-scroll :items="usersStore.blockedUsers" height="120" item-height="48">
      ...
      <v-card class="mx-auto" max-width="500">
        ...
        <v-virtual-scroll :items="usersStore.sentRequests" height="120" item-height="48">
          <template v-slot:default="{ item }">
            <v-list-item
      ...
      <v-card class="mx-auto" max-width="500">
        ...
        <v-virtual-scroll :items="usersStore.receivedRequests" height="120" item-height="48">
          <template v-slot:default="{ item }">
            <v-list-item
      ...
      <v-card class="mx-auto" max-width="500">
        ...
        <v-virtual-scroll :items="usersStore.users" height="120" item-height="48">
          <template v-slot:default="{ item }">
            <v-list-item
              :title="item.username"
              :subtitle="`Since ${usersStore.formatDate(item.createdAt)}`"
      ...
      <v-dialog v-model="updateDialog" max-width="500px">
        <v-card>
          ...
          <v-card-actions>
            <v-btn
              :color="isUpdateClickable ? 'primary' : 'disabled'"
