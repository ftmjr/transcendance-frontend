      ...
      >
        <div class="absolute top-0 left-0 flex justify-between w-full my-2">
          ...
          <div class="flex items-center px-4">
            <router-link
              :to="{ name: 'home' }"
              class="block ml-auto mr-0 text-xs text-white cursor-pointer hover:underline"
            >
              Retour
            </router-link>
          </div>
        ...
        >
          <div class="space-y-6 text-white">
            <h2 class="text-center text-white/60">
              <span class="text-xl font-bold text-center text-white/90"
                >Reinitialiser votre mot de passe</span
              >
            </h2>
            <p class="text-base text-center text-white/60 text-md">
              Veuillez saisir votre courriel pour recevoir un lien de réinitialisation
            </p>
          </div>
          ...
          <base-input
            ...
            errorMessage=""
            id="email"
            placeholder="gamerpro@monjeu.com"
            :required="true"
            label="Pseudo:"
            v-model:value="value"
            classnames="bg-darkBlue border-2 border-light/10 shadow-lg text-white/80 sm:text-sm rounded-md focus:ring-none block w-full p-2.5 placeholder-white/20 focus:outline-none focus:ring-0 relative focus:border-2 focus:border-light/30 animate-anime-in"
          />
          <div class="my-2">
            <base-button
